...
const homepage = {
    node: createNode(null, null).render(() => {
        return [{
            ...
            attr: {
                innerHTML: [
                    { name: "云制造服务组合", url: "./static/img/home_router_0.png" },
                    { name: "物流配送调度", url: "./static/img/home_router_1.png" },
                    { name: "生产计划排程", url: "./static/img/home_router_2.jpg" },
                    { name: "货运网络规划", url: "./static/img/home_router_3.png" }
                ].map(item => {
                    return (
