...
def pso_vrp():    
    ...
    if request.method == 'POST':
        data = json.loads(request.form.get('data'))
        lis = data['params'][0]
        pop_size = data['params'][1]
        iteration = data['params'][2]
        w = data['params'][3]
        c1 = data['params'][4]
        c2 = data['params'][5]
        car_count = data['params'][6]
        car_load = data['params'][7]
        r = data['params'][8]
        liss = []
        #print(lis)
        ...
        #print(liss)
        ans = PSO(liss,pop_size,iteration,w,c1,c2,car_count,car_load,r)
    return jsonify(ans)
